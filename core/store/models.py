...
class StoreItem(models.Model):
    ...
    image = models.CharField(max_length=255, blank=True, null=True, help_text="Path to image in public folder (e.g. /store/dracula.png)")
    item_data = models.JSONField(default=dict, blank=True, help_text="JSON data for functional items (e.g., theme_key)")
